                ...
                <?php 
                    while (have_posts()): the_post();
                            $category = get_the_category();
                                if ($category[0] -> cat_name == "Cover"):?>
                                var slides = document.getElementById("athena-slider");
                                var slide = document.createElement("div");
                                slide.id = "slide" + slideID;
                                slide.setAttribute("data-thumb","<?php echo esc_url( get_theme_mod('featured_image' , catch_that_image() ) ); ?>");
                                slide.setAttribute("data-src","<?php echo esc_url( get_theme_mod( 'featured_image', catch_that_image()) ); ?>");
   ...
   <div class="site-info">
       ...
       <div class="row">
           ...
           <div class="athena-copyright">
               <?php echo esc_attr( get_theme_mod( 'copyright_text', __( 'Copyright Alaric 2017', 'alaric' ) ) ); ?>
           </div>
           ...
           <a href="https://www.alaricbg.com" rel="designer" style="display: block !important" class="rel">
               Design By Alaric Zeng
           </a>
