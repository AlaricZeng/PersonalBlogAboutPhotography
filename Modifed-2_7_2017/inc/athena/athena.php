...
function athena_render_homepage() { ?>
    ...
    <div id="athena-jumbotron">
        ...
        <div id="athena-slider" class="hero">
            ...
            <div id="slide1" data-thumb="<?php echo esc_url( get_theme_mod('featured_image1', get_template_directory_uri() . '/inc/images/1.jpg' ) ); ?>" data-src="<?php echo esc_url( get_theme_mod( 'featured_image1', get_template_directory_uri() . '/inc/images/1.jpg' ) ); ?>">
            ...
            <div id="slide2" data-thumb="<?php echo esc_url(get_theme_mod('featured_image2', get_template_directory_uri() . '/inc/images/2.jpg')); ?>" data-src="<?php echo esc_url(get_theme_mod('featured_image2', get_template_directory_uri() . '/inc/images/2.jpg')); ?>">
            ...
            <!-- Try -->
            <div id="slide3" data-thumb="<?php echo esc_url(get_theme_mod('featured_image3', get_template_directory_uri() . '/inc/images/3.jpg')); ?>" data-src="<?php echo esc_url(get_theme_mod('featured_image3', get_template_directory_uri() . '/inc/images/3.jpg')); ?>">
                ...
                <div class="overlay">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 parallax">
                            <h2 class="header-text animated slideInDown slide3-header"><?php echo esc_attr( get_theme_mod( 'featured_image2_title', __( 'Welcome to Athena', 'athena' )  ) ); ?></h2>
            ...
            <!-- -->
            <div id="slide4" data-thumb="<?php echo esc_url(get_theme_mod('featured_image4', get_template_directory_uri() . '/inc/images/4.jpg')); ?>" data-src="<?php echo esc_url(get_theme_mod('featured_image4', get_template_directory_uri() . '/inc/images/4.jpg')); ?>">
